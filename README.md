...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">T<span>amil</span>T<span>ech</span></h1>
            <ul>
        ...
        <div class="content">
            <div class="text">
                <h2>Updating Day to day tech and General Knowledge</h2>
                <br>
                <p>  Transforming Ideas into Impartful Reality through Precision Coding and Innovation though various People </p>
                <br>
                <div>
    ...
    <footer>
        <center> Designed and Developed by V.Swaminathan (212223110057) </center>
    </footer>
</body>
</html>
people.html
...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">Tam<span>il</span>T<span>ech</span></h1>
            <ul>
                <li><a href="homes.html"> Home </a></li>
                <li><a href="Product.html"> Products </a></li>
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="naveen.jpj.jpg"> </td>
                    <td> <img src="Ak..jpg"> </td>
                    <td> <img src="Hari.jpg"> </td>
                    <td> <img src="mano.jpg"> </td>
                    <td> <img src="sajii.jpg"> </td>
                    <td> <img src="NASA.jpg"> </td>
                </tr>
                <tr align="center">
                    <th> Naveen </th>
                    <th> Aravind</th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(234, 80, 85);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                <h2> CONTACT INFO </h2>
                <p> <span>Address</span> : No.41 PERUMAL KOVIL STREET, Sipcot,ranipet </p>
                <p> <span>Email</span> : TamilTech@gmail.com.com </p>
                <p> <span>Phone</span> : 8056908701 </p>
            </div>
        </div>
    </div>
    <footer>
